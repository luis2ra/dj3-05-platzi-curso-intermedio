...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_questions(self):
        '''
        The method was_published_recently returns False for questions whose pub_date is in the future
        '''
    ...
    def test_was_published_recently_with_past_questions(self):
        '''
        The method was_published_recently returns False for questions whose pub_date is in the past
        '''
    ...
    def test_was_published_recently_with_present_questions(self):
        '''
        The method was_published_recently returns True for questions whose pub_date is in the present
        '''
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_no_question(self):
        '''
        if there is no question, display an appropriate message
        '''
    ...
    def test_with_future_questions(self):
        '''
        if there is a question from the future, do not show it on the index page
        '''
    ...
    def test_with_past_questions(self):
        '''
        if there is a question from the past, do show it on the index page
        '''
    ...
    def test_two_future_questions(self):
        '''
        The questions index page don't display multiple questions of future.
        '''
